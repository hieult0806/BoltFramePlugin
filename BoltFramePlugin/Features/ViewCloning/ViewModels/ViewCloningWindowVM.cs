...
using BoltFramePlugin.Features.ViewCloning.Services;
using BoltFramePlugin.Services;
using BoltFramePlugin.ViewModels;
using TaskDialog = Autodesk.Revit.UI.TaskDialog;

namespace BoltFramePlugin.Features.ViewCloning.ViewModels
{
    public class ViewCloningWindowVM : BaseViewModel
    {
        ...
        private readonly BoltFramePlugin.Features.ViewCloning.EventHandlers.CloneViewsEventHandler _cloneViewsHandler;
        ...
        public ViewCloningWindowVM(UIDocument uidoc) : base(uidoc)
        {
            ...
            _cloneViewsHandler = new BoltFramePlugin.Features.ViewCloning.EventHandlers.CloneViewsEventHandler();
