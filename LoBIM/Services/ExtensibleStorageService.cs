...
namespace LoBIM.Services
{
    ...
    public class ExtensibleStorageService : IExtensibleStorageService
    {
        ...
        private const string LimitingDistanceSchemaName = "LoBIM_LimitingDistanceData";
        private const string StorageElementName = "LoBIM_LimitingDistance_Storage";
        ...
        private Schema GetOrCreateLimitingDistanceSchema()
        {
            ...
            schemaBuilder.SetDocumentation("Stores limiting distance calculation data for LoBIM");
