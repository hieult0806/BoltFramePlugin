...
namespace LoBIM.Services
{
    public class LoggingService : ILoggingService, IDisposable
    {
        ...
        public LoggingService()
        {
            ...
            string logDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Revit", "LoBIM");
            Directory.CreateDirectory(logDirectory); // Ensure the directory exists

            _logFilePath = Path.Combine(logDirectory, "LoBIM.log");
