...
namespace LoBIM.Features.NBCReview.EventHandlers
{
    ...
    internal class CreateWallProjectionsEventHandler : IExternalEventHandler
    {
        ...
        private readonly NBCComplianceReportService _reportService;
        ...
        public CreateWallProjectionsEventHandler()
        {
            ...
            _reportService = DIContainerService.Container.GetInstance<NBCComplianceReportService>();
            ...
            (double Min, double Max, string Label, int ColorIndex) distanceGroup)
        {
            try
            {
                var typeName = $"NBC_{distanceGroup.Label.Replace(" ", "_").Replace("(", "").Replace("(", "").Replace(")", "").Replace("+", "plus")}";
